...
import { FaClipboardCheck, FaCalendarAlt, FaBook, FaTasks, FaClipboardList, FaStickyNote } from 'react-icons/fa';
    ...
    <div id="app-container-profesor" className={`container mt-5 ${darkMode ? 'dark-mode' : 'light-mode'}`}>
      ...
      <div className="row justify-content-center">
        {[
          ...
          { category: 'Examen', icon: <FaClipboardList size={40} />, path: '/Examen' },
          { category: 'Notas', icon: <FaStickyNote size={40} />, path: '/Notas' }, // Nuevo botón para "Notas"
        ].map((item, index) => (
