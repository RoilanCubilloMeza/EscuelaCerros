    ...
    <div className={`noticias-container ${darkMode ? 'noticias-dark' : 'noticias-light'}`}>
      <div className="container py-4">
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="form-group-modern">
                  <label htmlFor="Grado_Nombre" className="form-label-modern">
              ...
              <div className="col-md-6">
                <div className="form-group-modern">
                  <label htmlFor="Grado_Aula" className="form-label-modern">
                    <span className="label-icon">🚪</span>
                    Aula del Grado
                  </label>
                  <input
                    ...
                    placeholder="Ej: Aula 101, Aula A..."
                  />
                </div>
              </div>
            </div>
        ...
        <div className="noticias-table-card">
          <div className="card-header-custom">
            <h5 className="mb-0">📋 Lista de Grados</h5>
          </div>
          <div className="card-body-custom">
            {Grado_List.length > 0 ? (
                  ...
                  <tbody>
                    {Grado_List.map((val, key) => (
                      <tr key={key} className="table-row-hover">
                        <td className="td-id">
                          <span className="badge-id">{val.Grado_Id}</span>
                        </td>
                        <td>
                          <span className="badge bg-info text-dark">{val.Grado_Aula}</span>
                        </td>
                        <td className="td-nombre">
                          <div className="nombre-wrapper">
                            <span className="nombre-text">{val.Grado_Nombre}</span>
                          </div>
                        </td>
                        <td>
