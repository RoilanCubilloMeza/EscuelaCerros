    ...
    <div className="carousel-container">
      <MDBCarousel showControls showIndicators>
        {['pag1.jpg', 'pag2.jpg', 'pag3.jpg'].map((page, index) => (
          <MDBCarouselItem className="w-100 d-block" itemId={index + 1} src={`/${page}`} alt="...">
            <MDBCarouselCaption>
              <h5 className="animate__animated animate__fadeInDown">Actividades Importantes</h5>
    ...
    <div className="mt-5">
      <div className="row justify-content-center align-items-center">
        <div className="col-md-6 animate__animated animate__slideInLeft">
          <img src="/EscuelaHome.jpg" alt="Imagen de la escuela" className="img-fluid" />
        </div>
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <ul className="list-unstyled">
                <li>
                  <a href="https://www.facebook.com/profile.php?id=100082943875959" target="_blank" rel="noopener noreferrer">
                    <FaFacebook /> Facebook
                  </a>
                </li>
                <li>
