...
const LugarResidencia = () => {
  ...
  const getLista = async () => {
    try {
      const response = await authFetch(`${API_BASE_URL}/obtenerResidente`);
  ...
  const actualizar = () => {
    Axios.put(`${API_BASE_URL}/actualizarResidente`, {
      ...
      Swal.fire({
        ...
        html:
          '<i>La residencia <strong>' + Residencia_Direccion + '</strong> ha sido registrada.</i>',
        icon: 'success',
        timer: 3000,
      });
    });
  ...
  const eliminar = (Residencia_Id) => {
    Swal.fire({
      ...
      html: '<i>¿Realmente desea eliminar <strong>' + Residencia_Direccion + '</strong>?</i>',
      icon: 'warning',
      ...
      if (res.isConfirmed) {
        Axios.delete(`${API_BASE_URL}/deleteResidente/${Residencia_Id}`)
          .then(() => {
            getLista();
            limpiarDatos();
            Swal.fire('Eliminado', 'La residencia ha sido eliminada.', 'success');
          })
          .catch((error) => {
      ...
      <div className="container py-4">
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <p className="noticias-subtitle mb-0">
                  Información del lugar de residencia de estudiantes
                </p>
              </div>
            </div>
        ...
        <div className="noticias-form-card mb-5">
          <div className="card-header-custom">
            <h5 className="mb-0">{editar ? '✏️ Editar Residencia' : '➕ Registrar Residencia'}</h5>
          </div>
          <div className="card-body-custom">
            ...
            <h6 className="mb-3 mt-4 text-primary">🏡 Información de la Vivienda</h6>
            <div className="row">
              <div className="col-md-6">
                <div className="form-group-modern">
            ...
            <div className="action-buttons">
              {editar ? (
                ...
                <button type="button" className="btn-action btn-register" onClick={addResidencia}>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                    <path
                      d="M10 5V15M5 10H15"
                      stroke="currentColor"
                      ...
                      <tr key={key} className="table-row-hover">
                        ...
                        <td>
                          <span className="badge bg-info text-dark">
                            {val.Residencia_Comunidad}
                          </span>
                        </td>
                        <td className="td-nombre">
                          <div className="nombre-wrapper">
                            <span className="nombre-text">{val.Residencia_Direccion}</span>
                          </div>
                        </td>
                        <td>
