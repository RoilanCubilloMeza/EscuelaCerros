...
const Ocupacion = () => {
  ...
  const add = () => {
    ...
    Axios.post(`${API_BASE_URL}/createOcupacion`, {
      ...
      Swal.fire({
        ...
        html: '<i>La ocupación <strong>' + Ocupacion_Nombre + '</strong> ha sido registrada.</i>',
        icon: 'success',
        timer: 3000,
      });
    });
  ...
  const actualizar = () => {
    ...
    Swal.fire({
      ...
      html: '<i>La ocupación <strong>' + Ocupacion_Nombre + '</strong> ha sido actualizada.</i>',
      icon: 'success',
      timer: 3000,
    });
  };
  ...
  const eliminar = (Ocupacion_Id) => {
    Swal.fire({
      ...
      html: '<i>¿Realmente desea eliminar <strong>' + Ocupacion_Nombre + '</strong>?</i>',
      icon: 'warning',
      ...
      if (res.isConfirmed) {
        Axios.delete(`${API_BASE_URL}/deleteOcupacion/${Ocupacion_Id}`).then(() => {
          getLista();
          limpiarDatos();
        });
      ...
      <div className="container py-4">
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <p className="noticias-subtitle mb-0">
                  Ocupaciones de los encargados del estudiante
                </p>
              </div>
            </div>
        ...
        <div className="noticias-form-card mb-5">
          <div className="card-header-custom">
            <h5 className="mb-0">{editar ? '✏️ Editar Ocupación' : '➕ Registrar Ocupación'}</h5>
          </div>
