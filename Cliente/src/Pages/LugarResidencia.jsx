          ...
          <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
            <div className="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <p className="noticias-subtitle mb-0">Información del lugar de residencia de estudiantes</p>
              </div>
            </div>
            <div className="d-flex gap-2">
              <Link to="/Ocupacion" className="btn-back">
                  ...
                  <tbody>
                    {Residente_List.map((val, key) => (
                      <tr key={key} className="table-row-hover">
                        ...
                        <td>
                          <span className="badge bg-info text-dark">{val.Residencia_Comunidad}</span>
                        </td>
