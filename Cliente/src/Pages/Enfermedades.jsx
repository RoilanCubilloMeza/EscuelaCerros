...
const Enfermedades = () => {
  ...
  const add = () => {
    ...
    Axios.post(`${API_BASE_URL}/createEnfermedades`, {
      ...
      Swal.fire({
        ...
        html:
          '<i>La enfermedad <strong>' + Enfermedades_Nombre + '</strong> ha sido registrada.</i>',
        icon: 'success',
        timer: 3000,
      });
    });
  ...
  const getLista = async () => {
    try {
      const response = await authFetch(`${API_BASE_URL}/obtenerEnfermedades`);
  ...
  const actualizar = () => {
    ...
    Swal.fire({
      ...
      html:
        '<i>La enfermedad <strong>' + Enfermedades_Nombre + '</strong> ha sido actualizada.</i>',
      icon: 'success',
      timer: 3000,
    });
  };
  ...
  const eliminar = (Enfermedades_Id) => {
    Swal.fire({
      ...
      html: '<i>¿Realmente desea eliminar <strong>' + Enfermedades_Nombre + '</strong>?</i>',
      icon: 'warning',
            ...
            <div className="d-flex align-items-center gap-3">
              ...
              <div>
                ...
                <p className="noticias-subtitle mb-0">
                  Información médica y medicamentos de estudiantes
                </p>
              </div>
            </div>
